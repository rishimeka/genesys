...
class GraphStorageProvider(Protocol):
    ...
    async def vector_search(self, embedding: list[float], k: int = 10, status_filter: list[MemoryStatus] | None = None) -> list[tuple[MemoryNode, float]]: ...
...
class LLMProvider(Protocol):
    ...
    async def infer_causal_edges(self, new_memory: str, existing_memories: list[tuple[str, str]]) -> list[tuple[str, EdgeType, float]]: ...
